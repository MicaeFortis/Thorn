...
var PrefixesPage = /** @class */ (function (_super) {
    __extends(PrefixesPage, _super);
    function PrefixesPage() {
        ...
        _this.renderDeleteModal = function () { return (React.createElement(antd_1.Modal, { title: "Delete prefix", visible: _this.state.deletePrefixVisible, footer: false, closable: true, afterClose: function () { return _this.setState({ deletePrefixVisible: false }); }, onCancel: function () { return _this.setState({ deletePrefixVisible: false }); } },
        ...
        _this.renderEditModal = function () { return (React.createElement(antd_1.Modal, { title: "Add/Edit Prefix", visible: _this.state.editPrefixVisible, footer: false, closable: true, afterClose: function () { return _this.setState({ editPrefixVisible: false }); }, onCancel: function () { return _this.setState({ editPrefixVisible: false }); } },
    ...
    PrefixesPage.prototype.componentDidMount = function () {
        this.getPrefixes();
        this.getStatistics();
    };
    PrefixesPage.prototype.getPrefixes = function () {
        var _this = this;
        fetch('http://localhost:8080/api/prefixes', {
            headers: {
                'Accept': 'application/json',
    ...
    PrefixesPage.prototype.getStatistics = function () {
        var _this = this;
    ...
    PrefixesPage.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement(antd_1.Button, { className: "acceptButton floatRight", type: "primary", onClick: function () { return _this.openEditModalWithRecord(Prefix_1.getEmptyPrefix()); } }, "Add Prefix"),
...
exports.default = PrefixesPage;
//# sourceMappingURL=PrefixesPage.js.map