...
var Prefixes = /** @class */ (function (_super) {
    ...
    function Prefixes() {
        ...
        _this.getPrefixNameFromRecord = function (record) {
            if (!Utils_1.isEmpty(record.prefix)) {
                return record.prefix.name || '';
            }
            return '';
        };
        _this.getAdditionalValueForStatisticIfAny = function (record, statistic) {
            if (!Utils_1.isEmpty(record.prefix)) {
        ...
        _this.renderPrefixesSelector = function () {
            var options = _this.state.prefixes.map(function (prefix) { return React.createElement(Option, { value: prefix }, prefix.name); });
        ...
        _this.renderDeleteModal = function () { return (React.createElement(antd_1.Modal, { title: "Delete item", visible: _this.state.deleteItemVisible, footer: false, closable: true, onHide: function () { return _this.setState({ deleteItemVisible: false }); }, onCancel: function () { return _this.setState({ deleteItemVisible: false }); }, onExit: function () { return _this.setState({ deleteItemVisible: false }); }, onBackdropClick: function () { return _this.setState({ deleteItemVisible: false }); } },
        ...
        _this.renderEditModal = function () { return (React.createElement(antd_1.Modal, { title: "Add/Edit Item", visible: _this.state.editItemVisible, footer: false, closable: true, onHide: function () { return _this.setState({ editItemVisible: false }); }, onCancel: function () { return _this.setState({ editItemVisible: false }); }, onExit: function () { return _this.setState({ editItemVisible: false }); }, onBackdropClick: function () { return _this.setState({ editItemVisible: false }); } },
    ...
    Prefixes.prototype.getItems = function () {
        var _this = this;
        fetch('http://localhost:8080/api/items', {
            headers: {
                'Accept': 'application/json',
    ...
    Prefixes.prototype.getItemTypes = function () {
        var _this = this;
    ...
    Prefixes.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement(antd_1.Button, { className: "acceptButton floatRight", type: "primary", onClick: function () { return _this.openEditModalWithRecord({}); } }, "Add Item"),
